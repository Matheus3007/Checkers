...
class TestBoard(unittest.TestCase):
    ...
    def test_PiecePlacement(self):
        test_board = Board()
        self.assertEquals(test_board.GetPiece(0,0), 0) ## Checks if the first square is empty
        self.assertIsNot(test_board.GetPiece(0,1), 0) ## Checks if the first P2 piece is placed
        self.assertIsNot(test_board.GetPiece(7,0), 0) ## Checks if the first P1 piece is placed
